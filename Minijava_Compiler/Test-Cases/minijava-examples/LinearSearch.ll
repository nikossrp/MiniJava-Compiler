...
oob_2:
	...
	br i1 %_18, label %if_0, label %if_1
...
if_1:
	...
	%_22 = xor i1 1, %_21
	br i1 %_22, label %if_3, label %if_4
...
loop_0:
	...
	br i1 %_18, label %loop_1, label %loop_2
...
loop_1:
	...
	%_30 = add i32 %_28, %_29
	%_31 = icmp slt i32 %_27, %_26
	br i1 %_31, label %oob_0, label %oob_2

oob_0:
	%_32 = add i32 1, %_27
	%_33 = getelementptr i32, i32* %_25, i32 %_32
	store i32 %_30, i32* %_33
	br label %oob_2
