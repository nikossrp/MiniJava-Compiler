...
define i1 @Element.Equal(i8* %this, i8* %.other) {
	...
	%_17 = xor i1 1, %_16
	br i1 %_17, label %if_0, label %if_1
...
if_1:
	...
	%_35 = xor i1 1, %_34
	br i1 %_35, label %if_3, label %if_4
...
if_4:
	...
	%_38 = load i1, i1* %_37
	br i1 %_38, label %if_6, label %if_7
...
if_6:
	...
	%_46 = xor i1 1, %_45
	br i1 %_46, label %if_9, label %if_10
...
if_7:
	...
	br i1 %_53, label %if_12, label %if_13
...
andClause_0:
	br i1 %_8, label %andClause_1, label %andClause_3
...
andClause_3:
	%_11 = phi i1 [0, %andClause_0], [%_10, %andClause_2]
...
loop_1:
	...
	br i1 %_19, label %if_0, label %if_1
...
if_2:
	...
	%_46 = xor i1 1, %_45
	br i1 %_46, label %if_6, label %if_7
...
loop_0:
	...
	%_7 = xor i1 1, %_6
	br i1 %_7, label %loop_1, label %loop_2
...
loop_1:
	...
	br i1 %_15, label %if_0, label %if_1
