...
define i1 @Tree.Compare(i8* %this, i32 %.num1, i32 %.num2) {
	...
	br i1 %_4, label %if_0, label %if_1
...
if_1:
	...
	%_8 = xor i1 1, %_7
	br i1 %_8, label %if_3, label %if_4
...
loop_0:
	%_11 = load i1, i1* %cont
	br i1 %_11, label %loop_1, label %loop_2
...
loop_1:
	...
	br i1 %_21, label %if_0, label %if_1
...
if_0:
	...
	br i1 %_28, label %if_3, label %if_4
...
if_1:
	...
	br i1 %_57, label %if_6, label %if_7
...
loop_0:
	%_0 = load i1, i1* %cont
	br i1 %_0, label %loop_1, label %loop_2
...
loop_1:
	...
	br i1 %_10, label %if_0, label %if_1
...
if_0:
	...
	br i1 %_17, label %if_3, label %if_4
...
if_1:
	...
	br i1 %_28, label %if_6, label %if_7
...
if_6:
	...
	br i1 %_35, label %if_9, label %if_10
...
if_7:
	...
	br i1 %_44, label %if_12, label %if_13
...
if_12:
	...
	%_52 = xor i1 1, %_51
	br label %andClause_0

andClause_0:
	br i1 %_52, label %andClause_1, label %andClause_3
...
andClause_1:
	...
	%_60 = xor i1 1, %_59
	br label %andClause_2

andClause_2:
	br label %andClause_3

andClause_3:
	%_61 = phi i1 [0, %andClause_0], [%_60, %andClause_2]
	br i1 %_61, label %if_15, label %if_16
...
define i1 @Tree.Remove(i8* %this, i8* %.p_node, i8* %.c_node) {
	...
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if_0, label %if_1
...
if_1:
	...
	br i1 %_21, label %if_3, label %if_4
...
loop_0:
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %loop_1, label %loop_2
...
if_1:
	...
	br i1 %_27, label %if_6, label %if_7
...
if_6:
	...
	br i1 %_34, label %if_9, label %if_10
...
if_2:
	...
	br i1 %_33, label %if_3, label %if_4
...
if_2:
	...
	br i1 %_38, label %if_3, label %if_4
