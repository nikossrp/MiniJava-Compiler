...
andClause_0:
	br i1 1, label %andClause_1, label %andClause_3
...
andClause_3:
	%_1 = phi i1 [0, %andClause_0], [%_0, %andClause_2]
	br label %andClause_4

andClause_4:
	br i1 %_1, label %andClause_5, label %andClause_7
...
andClause_5:
	...
	%_4 = load i1, i1* %_3
	%_5 = xor i1 1, %_4
	br label %andClause_6

andClause_6:
	br label %andClause_7

andClause_7:
	%_6 = phi i1 [0, %andClause_4], [%_5, %andClause_6]
	store i1 %_6, i1* %b2
	%_7 = load i1, i1* %b2
	ret i1 %_7
