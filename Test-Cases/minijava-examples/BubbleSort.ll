...
loop_3:
	...
	br i1 %_11, label %loop_4, label %loop_5
...
loop_4:
	...
	br i1 %_19, label %oob_0, label %oob_1
...
oob_2:
	...
	br i1 %_28, label %oob_3, label %oob_4
...
oob_5:
	...
	br i1 %_34, label %if_0, label %if_1
...
if_0:
	...
	br i1 %_42, label %oob_6, label %oob_7
...
oob_8:
	...
	br i1 %_56, label %oob_12, label %oob_13

oob_12:
	%_57 = add i32 %_54, 1
	%_58 = getelementptr i32, i32* %_53, i32 %_57
...
oob_14:
	%_60 = icmp slt i32 %_50, %_49
	br i1 %_60, label %oob_9, label %oob_11

oob_9:
	%_61 = add i32 1, %_50
	%_62 = getelementptr i32, i32* %_48, i32 %_61
	store i32 %_59, i32* %_62
	br label %oob_11
...
oob_11:
	...
	%_67 = load i32, i32* %j
	%_68 = load i32, i32* %t
	%_69 = icmp slt i32 %_67, %_66
	br i1 %_69, label %oob_16, label %oob_18
